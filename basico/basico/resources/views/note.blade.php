            ...
            <div class="row">
                <div class="col">
                    ...
                    <small class="text-secondary"><span class="opacity-75 me-2">Created at: </span>
                        <strong>{{ date('Y-m-d H:i:s', strtotime($note['created_at'])) }}</strong><strong>
                        </strong>
                    </small>

                    @if ($note['created_at'] != $note['updated_at'])
                    <div class="text-secondary ms-5"><span class="opacity-75 me-2">updated at:
                            <small><strong><small>{{ date('Y-m-d H:i:s', strtotime($note['updated_at'])) }}</small></strong></small></span>
                    </div>
                @endif
                </div>
